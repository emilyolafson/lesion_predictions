...
one<-pvals_r2_all_FDR<0.05
two <-pvals_r2_all_FDR<0.01
three<-pvals_r2_all_FDR<0.001
four <-pvals_r2_all_FDR<0.0001
corr_comparisons <- cbind(tests, pvals_r2_all_FDR,one, two, three, four)
...
one<-pvals_corr_all_FDR<0.05
two <-pvals_corr_all_FDR<0.01
three<-pvals_corr_all_FDR<0.001
four <-pvals_corr_all_FDR<0.0001
corr_comparisons <- cbind(tests, pvals_corr_all_FDR,one, two, three, four)


corr_comparisons[,2] < 0.05
