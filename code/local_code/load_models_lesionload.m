function [r2scores, correl, nullr2scores, nullcorrel,alphas, feats, allactivations] = load_models_lesionload(varargin)
    ...
    for perm_number=1:24
        r2file = sprintf('%s%i_lesionload_scores.txt', filename_base,perm_number);
        corrfile = sprintf('%s%i_lesionload_correlations.txt', filename_base,perm_number);
