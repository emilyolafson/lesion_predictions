...
dev.on()
pdf(width=10, height=4,'/Users/emilyolafson/GIT/ENIGMA/enigma_disconnections/cortical_atrophy/PCA_3PCs_age_sex_regressed_hcpaging_hcpya_raw.pdf')
...
pcavar <- prcomp(d2[1:70] , center = TRUE,scale. = TRUE)
dev.on()
pdf(width=10, height=4,'/Users/emilyolafson/GIT/ENIGMA/enigma_disconnections/cortical_atrophy/PCA_3PCs_age_sex_regressed_hcpaging_hcpya_ComBat.pdf')
